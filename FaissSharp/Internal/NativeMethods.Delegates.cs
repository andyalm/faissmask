...
namespace FaissSharp.Internal
{
    internal partial class NativeMethods
    {
        ...
        public readonly Delegates.faiss_read_index_delegate faiss_read_index;
        ...
        public NativeMethods(UnmanagedLibrary library)
        {
            ...
            this.faiss_read_index = GetMethodDelegate<Delegates.faiss_read_index_delegate>(library);
        }
        public class Delegates
        {
            ...
            public delegate IntPtr faiss_read_index_delegate(string fname);
        }
    }
}